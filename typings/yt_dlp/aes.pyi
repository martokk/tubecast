...
def sub_bytes(data): # -> list[Unknown]:
    ...

def sub_bytes_inv(data): # -> list[Unknown]:
    ...

def rotate(data):
    ...

def key_schedule_core(data, rcon_iteration): # -> list[Unknown]:
    ...

def xor(data1, data2): # -> list[Unknown]:
    ...

def iter_mix_columns(data, matrix): # -> Generator[Unknown | int, None, None]:
    ...
