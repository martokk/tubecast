...
def sanitize_open(filename, open_mode): # -> tuple[BinaryIO | TextIO, Unknown] | tuple[Unknown, Unknown | str] | None:
...
def extract_basic_auth(url): # -> tuple[Unknown, None] | tuple[Unknown, str]:
    ...
...
class YoutubeDLCookieJar(http.cookiejar.MozillaCookieJar):
    ...
    def open(self, file, *, write=...): # -> Generator[IO[Any] | Unknown, None, None]:
        ...
...
def replace_extension(filename, ext, expected_real_ext=...): # -> str:
    ...
...
def cached_method(f): # -> (self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown:
    """Cache a method"""
    ...
