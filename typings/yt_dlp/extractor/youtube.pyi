...
class YoutubeBaseInfoExtractor(InfoExtractor):
    ...
    def generate_api_headers(self, *, ytcfg=..., account_syncid=..., session_index=..., visitor_data=..., identity_token=..., api_hostname=..., default_client=...): # -> dict[str, str | Unknown | Any | tuple[str | Unknown, ...] | object | list[Unknown] | None]:
        ...
